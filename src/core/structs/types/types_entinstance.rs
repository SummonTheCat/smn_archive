...
impl EntInstance {
    ...
    /// This uses Little-Endian for the scale value.
    pub fn to_bytes(&self) -> [u8; Self::BYTE_COUNT] {
        ...
        // Scale (f32) -> 4 bytes (use Little-Endian for scale)
    ...
    /// This assumes the scale value is stored in Little-Endian format.
    pub fn from_bytes(bytes: &[u8]) -> Self {
        ...
        // Extract Scale (f32) (4 bytes, Little-Endian)
